              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 13 }}>
                <thead style={{ background: 'var(--surface-2)', borderBottom: '1px solid var(--border)' }}>
                  <tr>
                    ...
                    <th style={{ padding: '12px 20px', color: 'var(--text-3)', fontSize: 11, fontWeight: 800, textTransform: 'uppercase' }}>Density Score</th>
                    <th style={{ padding: '12px 20px', color: 'var(--text-3)', fontSize: 11, fontWeight: 800, textTransform: 'uppercase' }}>Timestamp</th>
                    <th style={{ padding: '12px 20px', color: 'var(--text-3)', fontSize: 11, fontWeight: 800, textTransform: 'uppercase', textAlign: 'right' }}>Confidence</th>
                  </tr>
                </thead>
                <tbody>
